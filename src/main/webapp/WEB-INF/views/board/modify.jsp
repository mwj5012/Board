			...
			<main>
				<div class="container-fluid px-4">
					...
					<form role="form" method="post" autocomplete="off">
						...
						<input type="hidden" name="n" value="${detail.board_no }">
...
// 수정 페이지 카테고리 표시
var select_cateCode = '${detail.category_code}';
var select_cateCodeRef = '${detail.category_parent}';
var select_cateName = '${detail.category_name}';
