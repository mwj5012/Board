		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<form action="/board/write" role="form" id="writeForm" method="post" autocomplete="off" enctype="multipart/form-data">
						...
						<table class="table table-bordered">
							...
							<tr>
								<th>
									<label for="">제목</label>
									<input type="text" style="width: 100%" id="board_title" name="board_title" required />
								</th>
							</tr>
							...
							<tr>
								<th>
									<label for="">내용</label>
									<textarea cols="50" id="board_content" name="board_content" required></textarea>
								</th>
							</tr>
						...
						<button type="submit" id="write_button" onclick="moveWrite();">확인</button> &nbsp;
	...
	$("option:selected", this).each(function(){
		...
		for(var i = 0; i < cate3Arr.length; i++) {
			if(selectVal == cate3Arr[i].category_parent) {
				cate3Select.append("<option value='" + cate3Arr[i].category_code + "'>" + cate3Arr[i].category_name + "</option>");
			}
		}
	});
}); */
